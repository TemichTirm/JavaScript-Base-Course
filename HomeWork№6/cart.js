...
let productList = {
    products: [
        new Product(id = 1, productName = "Туфли", brand = "Carlo Pazolini", price = 100),
        new Product(id = 2, productName = "Шляпа", brand = "Borsalino", price = 20),
        new Product(id = 3, productName = "Пальто", brand = "Finn Flare", price = 300),
        new Product(id = 4, productName = "Рубашка", brand = "Henderson", price = 80),
